Views.content.b_technology = function() {
	...
	nav_rf.addEventListener('click', function(e){Controllers.content.renderSubView("b_rf_energy")});
	nav_access.addEventListener('click', function(e){Controllers.content.renderSubView("b_access_and_navigation")});
	nav_bone.addEventListener('click', function(e){Controllers.content.renderSubView("b_bone_cement")});
