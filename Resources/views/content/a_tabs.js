Views.content.a_tabs = function() {
	...
	var tab_attrs = [
		{name: "Technology", view_name: "a_technology", background: "images/tabs/tabs_technology.png", height:160, top:36}
		, {name: "Results", view_name: "a_results", background: "images/tabs/tabs_results.png", height:150, top:0}
		, {name: "Case Studies", view_name: "a_case_studies", background: "images/tabs/tabs_case_studies.png", height:190, top:0}
