Views.shared.tech_nav_star = function(current, prefix) {	
	prefix = prefix || "outer";
	...
	var bone_cement_button = Ti.UI.createButton({
		backgroundImage:"images/tripoint/tripoint_sm_blank.png",
		right:0,
		width:105,
		height:105,
		bottom:10,
	...
	var button_group = UI.ButtonGroup(rf_energy_button, access_and_navigation_button);
	
	if(current){
		var currentButton = {'access_and_navigation': access_and_navigation_button, 'rf_energy': rf_energy_button }[current];
